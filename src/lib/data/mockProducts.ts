...
export const MOCK_PRODUCTS: Product[] = [
  // --- ELECTRONICS ---
  {
    ...
    images: ['https://images.unsplash.com/photo-1695048133142-1a20484d256e?q=80&w=800'],
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1616763355548-1b606f439f86?q=80&w=800'],
    sellerId: 'system', createdAt: Date.now(), updatedAt: Date.now()
  },
  {
    id: 'mock-e3',
    ...
    images: ['https://images.unsplash.com/photo-1517336714460-4c50fd410f44?q=80&w=800'],
    sellerId: 'system', createdAt: Date.now(), updatedAt: Date.now()
  },
  {
    id: 'mock-e4',
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1610945265064-0630ea51145a?q=80&w=800'],
    sellerId: 'system', createdAt: Date.now(), updatedAt: Date.now()
  },
  {
    id: 'mock-e6',
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1576871337622-98d48d890e49?q=80&w=800'],
    sellerId: 'system', createdAt: Date.now(), updatedAt: Date.now()
  },
  {
    id: 'mock-c4',
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1473496169904-658ba7c44d8a?q=80&w=800'],
    sellerId: 'system', createdAt: Date.now(), updatedAt: Date.now()
  },
  ...
  // --- FURNITURE ---
  {
    ...
    images: ['https://images.unsplash.com/photo-1505797149-43c0ad43f994?q=80&w=800'],
    sellerId: 'system', createdAt: Date.now(), updatedAt: Date.now()
  },
  {
    id: 'mock-f2',
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1577140917170-285929fb55b7?q=80&w=800'],
    sellerId: 'system', createdAt: Date.now(), updatedAt: Date.now()
  },
  {
    id: 'mock-f4',
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1507473885765-e6ed047c992d?q=80&w=800'],
    sellerId: 'system', createdAt: Date.now(), updatedAt: Date.now()
  },
  {
    id: 'mock-f6',
  ...
  },
  {
    ...
    images: ['https://images.unsplash.com/photo-1598191383446-462f99ef33a8?q=80&w=800'],
    sellerId: 'system', createdAt: Date.now(), updatedAt: Date.now()
  },
  {
    id: 'mock-f8',
    ...
    images: ['https://images.unsplash.com/photo-1505693413171-293669746a57?q=80&w=800'],
    sellerId: 'system', createdAt: Date.now(), updatedAt: Date.now()
  }
];
